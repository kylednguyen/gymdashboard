      ...
      {OPTIONS.map((opt) => {
        ...
        return (
          <button
            ...
            className={`flex-1 cursor-pointer rounded-full px-3 py-2.5 text-sm font-semibold transition-all duration-150 active:scale-[0.98] ${
              active ? "bg-surface text-brand shadow-sm" : "text-muted"
            }`}
          >
            {opt.replace(" Day", "")}
          </button>
